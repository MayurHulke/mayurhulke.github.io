...
![](/images/blog/can-a-degree-in-electronics-could-lead-to-a-career-in-robotics/53caf6c3df.gif)

[Central Nervous System Mechanisms](https://www.google.com/url?sa=i&url=https%3A%2F%2Fmakeagif.com%2Fgif%2Fcentral-nervous-system-mechanisms-of-pain-modulation-EUOG9A&psig=AOvVaw2GzWG38mBL4GhUT6rt25aF&ust=1712157714832000&source=images&cd=vfe&opi=89978449&ved=0CBIQjhxqFwoTCNiD69Tqo4UDFQAAAAAdAAAAABAI)

It uses electrical and chemical signals to send and receive messages, right? Well, it's kind of like that with robots too. When we write code, it creates different signals to control various parts of the robot, so it can perform specific tasks. In robotics, there are lots of subsystems like `sensors`, `actuators`, `communication systems`, and `control systems` that need to work together seamlessly. And guess what? Electronics knowledge is super important for designing and implementing these subsystems and their interfaces. Plus, troubleshooting any issues that come up while building robots is crucial. Which below video from Tesla's actuator team, it will give you much better idea about why custom components are required in robots.

> With the rise of humanoid robots It is getting more and more common to design custom components in-house for better control. The team is talking about how Tesla has its own unique way of making actuators from start to finish. Unlike other companies that might use different… [pic.twitter.com/1dzekx06XM](https://t.co/1dzekx06XM?ref=mayurhulke.com)
>
> — Mayur H (@LetstalkRobots) [April 2, 2024](https://twitter.com/LetstalkRobots/status/1775192967688372674?ref_src=twsrc%5Etfw&ref=mayurhulke.com)
...
We can discuss each of these areas for hours if you like so feel free to drop me a DM on [instagram](https://www.instagram.com/lets_talk_with_robots/?ref=mayurhulke.com) or [Twitter](https://twitter.com/LetstalkRobots?ref=mayurhulke.com), and we can take it from there to make you understand the scale of robotics but the bottom line is there's are so many challenges that needs solving in these areas and for that we do need good electronics engineers.
...
[Sign up for future posts](#/portal/signup/free)
