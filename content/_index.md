...
{{< beat img="sketch-3-bionic-legs-brl" side="right" alt="A runner with a bionic leg at Bristol Robotics Laboratory" >}}
I later studied at the **University of Bristol** and spent a lot of time at the [**Bristol Robotics Laboratory**](https://www.bristolroboticslab.com/), one of the biggest robotics labs in the UK. While I was there, I worked on **intelligent bionic legs** for people with lower-limb amputation, alongside Paralympic athletes who needed prosthetics that could actually keep up with them.
{{< /beat >}}

{{< beat img="sketch-4-the-lesson" side="left" alt="A flashy demo set against giving someone a piece of life back" >}}
...
{{< beat img="sketch-5-teaching-machines-to-see" side="right" alt="A video frame broken into an action-segmentation timeline" >}}
...
{{< beat img="sketch-6-factories-that-see" side="left" alt="A factory connected to a network of 60+ sites" >}}
...
{{< beat img="sketch-8-the-open-question" side="left" alt="A small robot facing an open horizon" >}}
...
Right now I'm building toward that at Almetra, where I lead our collaborations with frontier robotics partners including [**Google DeepMind Robotics**](https://blog.google/topics/google-europe/powering-the-future-of-robotics-in-europe/?utm_source=linkedin&utm_medium=social&utm_campaign=&utm_content=), [**MassRobotics**](https://www.massrobotics.org/massrobotics-aws-and-nvidia-announce-second-cohort-of-physical-ai-fellowship/), [**AWS**](https://www.massrobotics.org/massrobotics-aws-and-nvidia-announce-second-cohort-of-physical-ai-fellowship/), and [**NVIDIA**](https://www.massrobotics.org/massrobotics-aws-and-nvidia-announce-second-cohort-of-physical-ai-fellowship/). I also write about robotics and physical intelligence on [my blog](https://letstalkwithrobots.substack.com/?utm_campaign=profile_chips), mostly for people who are as obsessed with useful robots as I am.
